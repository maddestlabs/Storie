...
function findWasmBinary() {
  return locateFile('raylib_test.wasm');
}
...
var ASM_CONSTS = {
 ...
 94506: () => { return parseInt(document.getElementById('canvas').style.width); },  
 94574: () => { document.exitFullscreen(); },  
 94601: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 94674: () => { if (document.fullscreenElement) return 1; },  
 94720: () => { return document.getElementById('canvas').width; },  
 94772: () => { return screen.width; },  
 94797: () => { document.exitFullscreen(); },  
 94824: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 94957: () => { return window.innerWidth; },  
 94983: () => { return window.innerHeight; },  
 95010: () => { if (document.fullscreenElement) return 1; },  
 95056: () => { return document.getElementById('canvas').width; },  
 95108: () => { return parseInt(document.getElementById('canvas').style.width); },  
 95176: () => { if (document.fullscreenElement) return 1; },  
 95222: () => { return document.getElementById('canvas').width; },  
 95274: () => { return screen.width; },  
 95299: () => { return window.innerWidth; },  
 95325: () => { return window.innerHeight; },  
 95352: () => { if (document.fullscreenElement) return 1; },  
 95398: () => { return document.getElementById('canvas').width; },  
 95450: () => { return screen.width; },  
 95475: () => { document.exitFullscreen(); },  
 95502: () => { if (document.fullscreenElement) return 1; },  
 95548: () => { return document.getElementById('canvas').width; },  
 95600: () => { return parseInt(document.getElementById('canvas').style.width); },  
 95668: () => { document.exitFullscreen(); },  
 95695: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 95753: () => { return screen.width; },  
 95778: () => { return screen.height; },  
 95804: () => { return window.screenX; },  
 95831: () => { return window.screenY; },  
 95858: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 95911: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 95982: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 96039: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 96295: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 96366: () => { if (document.fullscreenElement) return 1; },  
 96412: () => { return window.innerWidth; },  
 96438: () => { return window.innerHeight; },  
 96465: () => { if (document.pointerLockElement) return 1; }
};
