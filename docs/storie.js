...
// end include: /tmp/tmp5g0anyi_.js
// include: /tmp/tmpgstw92o5.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpgstw92o5.js
// include: /tmp/tmpzeikhgf7.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpzeikhgf7.js
...
var ASM_CONSTS = {
  4260520: () => { if (typeof Module !== 'undefined' && typeof Module.waitingForGist !== 'undefined' && Module.waitingForGist === true) { return 1; } return 0; },  
 4260665: () => { if (document.fullscreenElement) return 1; },  
 4260711: () => { return document.getElementById('canvas').width; },  
 4260763: () => { return parseInt(document.getElementById('canvas').style.width); },  
 4260831: () => { document.exitFullscreen(); },  
 4260858: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 4260931: () => { if (document.fullscreenElement) return 1; },  
 4260977: () => { return document.getElementById('canvas').width; },  
 4261029: () => { return screen.width; },  
 4261054: () => { document.exitFullscreen(); },  
 4261081: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 4261214: () => { return window.innerWidth; },  
 4261240: () => { return window.innerHeight; },  
 4261267: () => { if (document.fullscreenElement) return 1; },  
 4261313: () => { return document.getElementById('canvas').width; },  
 4261365: () => { return parseInt(document.getElementById('canvas').style.width); },  
 4261433: () => { if (document.fullscreenElement) return 1; },  
 4261479: () => { return document.getElementById('canvas').width; },  
 4261531: () => { return screen.width; },  
 4261556: () => { return window.innerWidth; },  
 4261582: () => { return window.innerHeight; },  
 4261609: () => { if (document.fullscreenElement) return 1; },  
 4261655: () => { return document.getElementById('canvas').width; },  
 4261707: () => { return screen.width; },  
 4261732: () => { document.exitFullscreen(); },  
 4261759: () => { if (document.fullscreenElement) return 1; },  
 4261805: () => { return document.getElementById('canvas').width; },  
 4261857: () => { return parseInt(document.getElementById('canvas').style.width); },  
 4261925: () => { document.exitFullscreen(); },  
 4261952: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 4262010: () => { return screen.width; },  
 4262035: () => { return screen.height; },  
 4262061: () => { return window.screenX; },  
 4262088: () => { return window.screenY; },  
 4262115: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 4262168: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 4262239: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 4262296: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 4262552: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 4262623: () => { if (document.fullscreenElement) return 1; },  
 4262669: () => { return window.innerWidth; },  
 4262695: () => { return window.innerHeight; },  
 4262722: () => { if (document.pointerLockElement) return 1; }
};
